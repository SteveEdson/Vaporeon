...
},{"./components/app.vue":2,"./components/task.vue":3,"vue":7,"vue-async-data":4,"vue-router":6}],2:[function(require,module,exports){
    ...
    data: function data() {
        return {
            ...
            tasks: [{
                id: 123,
                title: 'Finish stuff',
                body: 'Get everything done'
            }, {
                id: 999,
                title: 'Finish something else',
                body: 'Get everything done'
            }]
        };
    }
...
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div class=\"pane-group\">\n      <div class=\"pane sidebar\">\n          <div class=\"list-group-header\">\n            <input class=\"form-control\" type=\"text\" placeholder=\"Search for someone\" v-model=\"search\">\n          </div>\n        <ul class=\"list-group\">\n          <li class=\"list-group-item\" v-link-active=\"\" v-for=\"task in tasks | filterBy search\">\n              <a v-link=\"{ name: 'task', params: { 'task': task.id }, activeClass: 'active' }\">\n                <img class=\"img-circle media-object pull-left\" src=\"https://placeholdit.imgix.net/~text?txtsize=33&amp;txt=350%C3%97350&amp;w=350&amp;h=350\" width=\"32\" height=\"32\">\n                <div class=\"media-body\">\n                  <strong>{{ task.title }}</strong>\n                  <p>{{ task.body }}</p>\n                </div>\n                </a>\n          </li>\n        </ul>\n      </div>\n      <div class=\"pane\">\n          <router-view></router-view>\n      </div>\n    </div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/Steve/Repos/electron-quick-start/lib/components/app.vue"
...
},{"vue":7,"vue-hot-reload-api":5,"vueify-insert-css":8}],3:[function(require,module,exports){
var __vueify_style__ = require("vueify-insert-css").insert("\n.red {\n  color: #f00;\n}\n")
"use strict";
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/Steve/Repos/electron-quick-start/lib/components/task.vue"
  module.hot.dispose(function () {
    require("vueify-insert-css").cache["\n.red {\n  color: #f00;\n}\n"] = false
    document.head.removeChild(__vueify_style__)
  })
...
},{"vue":7,"vue-hot-reload-api":5,"vueify-insert-css":8}],4:[function(require,module,exports){
(function () {
  var vue // lazy bind
